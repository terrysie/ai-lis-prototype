...
ipcMain.handle('reportPublish:publish', async (_event, resultId) => publishReport(
  resultId,
  { userId: 2, username: 'chen.review' },
  { electronApp: app }
));
...
ipcMain.handle('reagentExpiryAlerts:handle', async (_event, alertId, handling) => handleReagentExpiryAlert(
  alertId,
  handling,
  { userId: 1, username: 'admin' },
  { electronApp: app }
